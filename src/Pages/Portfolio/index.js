  ...
  const cardContent = [
    {
      title: "Devise",
      description:
        "Full stack web application designed for developers to interact and share project ideas.",
      image: Devise,
      languages:
        "React, GraphQL, MongoDB, Mongoose, Material UI, Apollo, CSS, Node.js",
      deployed: "https://devise-collaboration-platform.herokuapp.com/",
      repo: "https://github.com/Brainybrian316/DEVise",
    },
    {
      title: "Dad Joke Generator",
      description:
        "This full stack application allows users to create an account. Once signed in the user can generate dad joke meme templates and view them in their gallery. Data stored in a SQL database. Passwords are encrypted",
      image: Dad,
      languages:
        "Express.js, SQL, Sequelize, Node.js, Javascript, Bootstrap, bycrypt",
    ...
    },
    {
      ...
      description:
        "This is a backend server used for creating users who can post thoughts and react to those thoughts. All data is stored in a MongoDB database",
      image: Social,
    ...
    },
    {
      title: "Note Taker",
      description:
        "This project creates an online note-taker which allows the user to take notes, save them, and delete them.",
      image: Note,
    ...
    },
    {
      ...
      description:
        "A front end site for generating highly rated restaurants in the area pulled from Google Places API.",
      image: Restaurant,
            ...
            <Grid item xs="auto">
              <Card
                ...
                sx={{
                  ...
                  background: "#5b6467",
                  backgroundImage:
                    "linear-gradient(315deg, #5b6467 0%, #8b939a 74%)",
              ...
              >
                ...
                >
                  {project.deployed ? (
                    <StyledButton
                      variant="contained"
                      onClick={() => openSite(project.deployed)}
                    >
                      Deployed Site
                    </StyledButton>
                  ) : null}
